   ...
   <@uniqueIdDiv>
      <div class="dashlet my-meeting-workspaces">
		...
		<!--   <h3>${msg("label.noMeetingWorkspaces")}</h3>		-->
			   <form action="/alfresco/service/docType" method="post">
  Name:<br>
  <input type="text" name="typeName" placeholder="enter name here">
  <br>
  Id:<br>
  <input type="text" name="typeId" placeholder="enter id here">
  <br>
  Description:<br>
  <input type="text" name="typeDesc" placeholder="description here">
  <br>
